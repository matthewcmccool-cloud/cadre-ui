    ...
    <>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .lp-pricing { flex-wrap: wrap; justify-content: center; gap: 12px; }
      ...
      <div className="lp">
        ...
        <div className="lp-content">
          ...
          {/* CTA */}
          <button className="lp-cta" onClick={() => { setShowModal(true); setSubmitted(false); }}>
        ...
        {showModal && (
          <div className="lp-overlay" onClick={(e) => { if (e.target === e.currentTarget) setShowModal(false); }}>
            <div className="lp-modal">
              <button className="lp-modal-close" onClick={() => setShowModal(false)} aria-label="Close">
                &times;
              </button>
              ...
              {submitted ? (
                ...
                <>
                  <div className="lp-modal-title">Get in touch</div>
