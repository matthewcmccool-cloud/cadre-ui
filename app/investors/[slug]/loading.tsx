  ...
  return (
    <main className="min-h-screen bg-zinc-950">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Header: name + bio */}
        <div className="h-8 w-56 bg-zinc-800 rounded animate-pulse mb-3" />
        <div className="h-4 w-3/4 bg-zinc-800/60 rounded animate-pulse mb-2" />
        <div className="h-4 w-1/2 bg-zinc-800/60 rounded animate-pulse mb-6" />
